...
["apifm-wxapi"使用教程](https://www.jianshu.com/c/b44a52c3cb44)
...
1. 免费注册开通后台管理账号并获得api接口权限；
   ...
   > 注册成功后登录后台，左侧菜单 “工厂设置” -> “模块管理” ，点击 “一键开启商城模块” 按钮，退出重新登录一次后台就可以看到菜单了

2. 在你的小程序目录下安装 apifm-wxapi 模块；
   > 在命令行模式下进入到你的小程序根目录

   > 检查下你的根目录下有没有 package.json 文件，如果没有这个文件，说明你的项目还不是 npm 项目，需要先做一下初始化（初始化操作不会对你现有项目有什么影响，可以放心操作），初始化命令为 npm init （之后的提示一路回车下去就可以了）

   > npm install apifm-wxapi

   > 安装完毕后，点击微信小程序开发工具--> 工具 --> 构建 npm
...
4. 在您需要的地方引用工具类
   ...
   > <img src="https://dcdn.it120.cc/2019/07/31/7615d968-c7e3-48db-954b-27e881c72760.png">
